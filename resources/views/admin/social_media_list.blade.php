                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @foreach($list as $item)
                                <tr id="{{$item->id}}">
                                    <td>{{$item->id}}</td>
                                    <td><a href="{{route('admin.socialMedia.add', ['socialMediaID' => $item->id])}}" class="btn btn-warning editEducation">Düzenle<i class="mdi mdi-pencil-box-outline"></i></a></td>
            ...
            $.ajax({
                ...
                success: function (response){
                    Swal.fire({
                        icon: 'success',
                        title: 'Başarılı!',
                        text: response.socialMediaID + " ID'li kayıt durumu " + response.newStatus + " olarak güncellenmeiştir.",
