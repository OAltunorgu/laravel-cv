    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.socialMedia.list')}}">Sosyal Medya Hesaplarınız</a></li>
                ...
                <div class="card-body">
                    <form class="forms-sample" id="createExperienceForm" method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" placeholder="Ad" value="{{$socialMedia ? $socialMedia->name : ''}}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="icon" id="icon" placeholder="Icon" value="{{$socialMedia ? $socialMedia->icon : ''}}">
                            <small><a href="https://fontawesome.com/icons?d=gallery&s=brands" target="_blank">Kullanabileceğiniz sosyal medya ikonları için tıklayınız.</a></small>
                            @error('icon')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-success">
                                <label class="form-check-label" for="status">
                                    ...
                                    <input type="checkbox" name="status" id="status" class="form-check-input" {{$checkStatus}}>Sosyal Medya Gösterimi Yapılsın Mı?
                                </label>
                            </div>
                        </div>
